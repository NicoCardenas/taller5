...
public class ValidateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Optional<String> optId = Optional.ofNullable(req.getParameter("personID"));
		Optional<String> optSalary = Optional.ofNullable(req.getParameter("salary"));
		Optional<String> optSS = Optional.ofNullable(req.getParameter("SocialSecurity"));
		employee = new Employee(Integer.parseInt(optId.get()), Long.parseLong(optSalary.get()), SocialSecurityType.valueOf(optSS.get()));
